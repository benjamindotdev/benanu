...
//           <p className="text-gray-600">{travelData.distance}</p>
//         </div>
//         <div className="bg-white p-6 rounded-lg shadow-lg">
...
//           <p className="text-gray-600">{travelData.co2Emissions}</p>
//         </div>
//         <div className="bg-white p-6 rounded-lg shadow-lg">
//           <h3 className="text-xl font-semibold mb-2">CO2 Emissions Saved</h3>
//           <p className="text-gray-600">{travelData.co2EmissionsSaved}</p>
//         </div>
//       </div>
//     </div>
//   );
